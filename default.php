<?php 
  ...
  if(file_exists("images/$doc/usuario.png")){
    $imagem='<img src="images/' . $doc .'/usuario.png" class="user-image" alt="User Image">';
  } else {
    $imagem='<i class="fa fa-user-circle"></i>';
  }
?>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <?php 
                  } else {echo '<h1><i class="fa fa-user-circle img-circle"></i></h1>';}
                ?>
              <p><strong><?php echo $nome; ?></strong>
              <small>Membro desde <?php echo $datacad; ?></small>
              </p>
              </li>
              <!-- Menu Body -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="?modulo=cliente&amp;acao=editar" class="btn btn-default btn-flat">Editar</a>
                </div>

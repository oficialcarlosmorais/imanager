  <!-- Content Header (Page header) -->
    <section class="content-header">
      <a href="default.php">Home</a> / Receitas / adicionar
    </section>
		...
		<div class="box">
	        ...
	        <?php
				if(isset($_POST['botao']) && $_POST['botao'] == "Salvar"){ 
		    		...
		    		$receitas->adicionar();
		    		echo "<a href='default.php?modulo=receitas&acao=listar'><div class='alert alert-info alert-dismissible'><button type='button' class='close'>&times;</button><strong>Receita adicionada com sucesso!</strong></div></a>";		    		
				} else {
			?>
				...
				<form method='post' action=''>
					...
					<div class="form-group">
				    	...
				    	<input type="text" class="form-control" id="receita" name="receita" placeholder="Nome do ganho">
					</div>
					<div class="form-group">
